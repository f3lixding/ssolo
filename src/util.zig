...
var worldVerticesPositions: [MAX_VERTICES_PER_ATTACHMENT]f32 = undefined;
var vertices: [MAX_VERTICES_PER_ATTACHMENT]Vertex = undefined;
...
/// Maybe we change the signature so that it doesn't direclty call sg's api?
/// Not sure how important this is
pub fn collectSkeletonVertices(skel: *spine_c.spSkeleton) void {
    total_vertex_count = 0;
    // var texture: ?*sg.Image = null;
...
fn addVertex(x: f32, y: f32, u: f32, v: f32, r: f32, g: f32, b: f32, a: f32, index: *usize) void {
    ...
    const normalized_x = (x / 400.0) - 1.0; // 800/2 = 400
    const normalized_y = (y / 300.0) - 1.0; // 600/2 = 300, no Y flip for now
