...
//
//    Cmdline:
//        sokol-shdc -i src/shaders/menu.glsl -o src/shaders/menu.glsl.zig -l glsl410:glsl300es:hlsl5:metal_macos:wgsl -f sokol_zig
//
//    Overview:
//    =========
//    Shader program: 'menu':
//        Get shader desc: shd.menuShaderDesc(sg.queryBackend());
//        Vertex Shader: vs
//        Fragment Shader: fs
//        Attributes:
//            ATTR_menu_pos => 0
...
//    Bindings:
//
pub const ATTR_menu_pos = 0;
pub const ATTR_menu_color0 = 1;
pub const ATTR_menu_uv0 = 2;
//
//    #version 410
//
...
//
//
const vs_source_glsl410 = [297]u8 {
    ...
    0x20,0x76,0x65,0x63,0x32,0x28,0x75,0x76,0x30,0x2e,0x78,0x2c,0x20,0x75,0x76,0x30,
...
//
//
const vs_source_glsl300es = [258]u8 {
    ...
    0x76,0x30,0x2e,0x78,0x2c,0x20,0x75,0x76,0x30,0x2e,0x79,0x29,0x3b,0x0a,0x7d,0x0a,
    0x0a,0x00,
};
//
//    #version 300 es
...
//
//
const fs_source_glsl300es = [193]u8 {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
...
const vs_source_hlsl5 = [816]u8 {
    ...
    0x6c,0x6f,0x61,0x74,0x32,0x28,0x75,0x76,0x30,0x2e,0x78,0x2c,0x20,0x75,0x76,0x30,
    0x2e,0x79,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x53,0x50,0x49,0x52,0x56,0x5f,0x43,0x72,
...
const vs_source_metal_macos = [532]u8 {
    ...
    0x30,0x2e,0x78,0x2c,0x20,0x69,0x6e,0x2e,0x75,0x76,0x30,0x2e,0x79,0x29,0x3b,0x0a,
...
const vs_source_wgsl = [717]u8 {
    ...
    0x65,0x63,0x32,0x66,0x28,0x75,0x76,0x30,0x2e,0x78,0x2c,0x20,0x75,0x76,0x30,0x2e,
    0x79,0x29,0x3b,0x0a,0x20,0x20,0x72,0x65,0x74,0x75,0x72,0x6e,0x3b,0x0a,0x7d,0x0a,
...
pub fn menuShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    var desc: sg.ShaderDesc = .{};
    desc.label = "menu_shader";
    switch (backend) {
        .GLCORE => {
