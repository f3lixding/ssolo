...
//
//    Cmdline:
//        sokol-shdc -i src/shaders/cursor.glsl -o src/shaders/cursor.glsl.zig -l glsl410:glsl300es:hlsl5:metal_macos:wgsl -f sokol_zig
//
//    Overview:
//    =========
//    Shader program: 'cursor':
//        Get shader desc: shd.cursorShaderDesc(sg.queryBackend());
//        Vertex Shader: vs
//        Fragment Shader: fs
//        Attributes:
//            ATTR_cursor_pos => 0
//            ATTR_cursor_color0 => 1
//            ATTR_cursor_uv0 => 2
//    Bindings:
...
//            Bind slot: SMP_smp => 0
//
pub const ATTR_cursor_pos = 0;
pub const ATTR_cursor_color0 = 1;
pub const ATTR_cursor_uv0 = 2;
...
//
//
const vs_source_glsl410 = [387]u8 {
    ...
    0x75,0x76,0x30,0x2e,0x78,0x2c,0x20,0x75,0x76,0x30,0x2e,0x79,0x29,0x3b,0x0a,0x7d,
    0x0a,0x0a,0x00,
};
//
//    #version 410
...
//
//
const vs_source_glsl300es = [348]u8 {
    ...
    0x6c,0x61,0x79,0x6f,0x75,0x74,0x28,0x6c,0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x20,
    0x3d,0x20,0x32,0x29,0x20,0x69,0x6e,0x20,0x76,0x65,0x63,0x32,0x20,0x75,0x76,0x30,
    ...
    0x76,0x20,0x3d,0x20,0x76,0x65,0x63,0x32,0x28,0x75,0x76,0x30,0x2e,0x78,0x2c,0x20,
    0x75,0x76,0x30,0x2e,0x79,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
//
//    #version 300 es
...
const vs_source_hlsl5 = [919]u8 {
    ...
    0x32,0x20,0x75,0x76,0x30,0x3b,0x0a,0x0a,0x73,0x74,0x72,0x75,0x63,0x74,0x20,0x53,
...
const vs_source_metal_macos = [622]u8 {
    ...
    0x75,0x76,0x30,0x20,0x5b,0x5b,0x61,0x74,0x74,0x72,0x69,0x62,0x75,0x74,0x65,0x28,
    ...
    0x6f,0x61,0x74,0x32,0x28,0x69,0x6e,0x2e,0x75,0x76,0x30,0x2e,0x78,0x2c,0x20,0x69,
    0x6e,0x2e,0x75,0x76,0x30,0x2e,0x79,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x72,0x65,
...
//
//    fn main_1() {
//      gl_Position = (x_19.mvp * vec4f(pos.x, pos.y, 0.0f, 1.0f));
//      color = color0;
...
const vs_source_wgsl = [842]u8 {
    ...
    0x20,0x76,0x65,0x63,0x34,0x66,0x28,0x70,0x6f,0x73,0x2e,0x78,0x2c,0x20,0x70,0x6f,
...
pub fn cursorShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    var desc: sg.ShaderDesc = .{};
    desc.label = "cursor_shader";
    switch (backend) {
        .GLCORE => {
